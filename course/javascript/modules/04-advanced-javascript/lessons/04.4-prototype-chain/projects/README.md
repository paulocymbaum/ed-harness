...
- `Object.create(proto)` links without copying
- `Object.assign` copies properties as own properties
- `Object.hasOwn` only reports own properties
- `key in obj` checks the whole prototype chain
...
Classify a key as `own`, `inherited`, or `missing` on an object built with `Object.create` + `Object.assign`.
