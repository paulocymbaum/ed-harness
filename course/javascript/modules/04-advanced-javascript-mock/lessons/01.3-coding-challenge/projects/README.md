...
- Private state (`factor`) is unreachable from outside except via exposed methods
...
### 001-closure-multiplier/

Build a private multiplier via a closure factory (`mul`/`get` commands over stdin).
