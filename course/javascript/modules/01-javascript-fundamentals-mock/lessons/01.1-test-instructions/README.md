...
Welcome to the **JavaScript Fundamentals** mock test.

## What is assessed

This screening covers module **01 — JavaScript Fundamentals**:

- Primitive types, `typeof`, and truthiness
- Variables (`let`, `const`), operators, and coercion
...
1. **Multiple choice** — 8 questions on types, operators, control flow, and functions
2. **Coding challenge** — implement a `clamp` utility that reads three numbers from stdin
