...
- Count array length is max - min + 1
- Cost tracks n + k for range k
- Huge ranges make counting sort impractical
...
### 001 — Count Range Sizer

Compute count-array size from min and max.
