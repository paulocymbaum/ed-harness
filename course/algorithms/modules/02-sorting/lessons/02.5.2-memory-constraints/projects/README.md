...
- Merge needs Θ(n) buffers
- Heap keeps O(1) extra array space with n log n
- Choose by RAM policy, not only Big-O time
...
### 001 — Memory Sort Advisor

Recommend merge vs heap from a memory policy id.
