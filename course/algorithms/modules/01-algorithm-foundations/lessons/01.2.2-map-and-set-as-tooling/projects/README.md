# Projects — Map and Set as Tooling
...
- Set/Map give ~O(1) average membership/lookup
- Array→Set turns O(n·m) includes into O(n+m)
- Object keys coerce; prefer Map for non-string keys
...
### 001 — Shared Membership Checker

Detect shared values between two lists in O(n+m) Set style.
