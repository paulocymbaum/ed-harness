...
- slice/map/filter/spread allocate O(n) auxiliary
- In-place mutation can be O(1) auxiliary
- Recursion depth n often costs O(n) stack space
...
### 001 — Aux Space Reporter

Report auxiliary space class for known patterns.
