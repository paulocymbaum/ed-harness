...
- Halving yields O(log n) levels; O(n) per level → O(n log n)
...
### 001 — Divide Levels Reporter

Report how many halving levels a power-of-two input needs until size 1.
